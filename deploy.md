...
**SMSC возвращает "no money"** — пополни баланс на smsc.ru. Без этого OTP идут
в `stdout` контейнера (`docker compose logs backend | grep DEV`).
