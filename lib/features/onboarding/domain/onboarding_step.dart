...
class OnboardingFlow {
  ...
  static const concernsStep = OnboardingStep(
    ...
    options: [
      ...
      StepOption(id: 'blackheads', title: 'Чёрные точки'),
      StepOption(id: 'pih', title: 'Постакне'),
      StepOption(id: 'pores', title: 'Расширенные поры'),
      StepOption(id: 'oiliness', title: 'Жирный блеск'),
      StepOption(id: 'dryness', title: 'Сухость'),
      StepOption(id: 'dehydration', title: 'Обезвоженность'),
      StepOption(id: 'redness', title: 'Покраснения'),
      StepOption(id: 'rosacea', title: 'Розацеа / купероз'),
      StepOption(id: 'sensitivity', title: 'Чувствительная кожа'),
      StepOption(id: 'aging', title: 'Признаки старения'),
      StepOption(id: 'wrinkles', title: 'Морщины'),
      StepOption(id: 'elasticity', title: 'Упругость и плотность'),
      StepOption(id: 'dullness', title: 'Тусклый тон'),
      StepOption(id: 'pigmentation', title: 'Пигментация'),
      StepOption(id: 'texture', title: 'Неровный рельеф'),
      StepOption(id: 'dark_circles', title: 'Круги под глазами'),
      StepOption(id: 'puffiness', title: 'Отёчность'),
      StepOption(id: 'barrier', title: 'Восстановление барьера'),
      StepOption(id: 'post_procedure', title: 'После процедур'),
    ],
  );
